...
titles_path  = os.path.join(desktop, "title_PR.txt")
download_dir = os.path.join(desktop, "PR_原始文件")
output_path  = os.path.join(desktop, "title_PR_output.xlsx")

os.makedirs(download_dir, exist_ok=True)

# =========================
# 2. AES-GCM 解密（密钥仅通过环境变量 PR_TITLE_ENCRYPT_AES_KEY_B64 提供）
# =========================
...
AES_KEY = _aes_key_from_env("PR_TITLE_ENCRYPT_AES_KEY_B64")
...
# =========================
# 4. Content-Type 映射 & magic number 识别（保留供参考）
# =========================
# CONTENT_TYPE_MAP = {
#     "application/pdf": ".pdf",
...
for url, title_hex, owner in rows:
    ...
    file_path     = find_downloaded_file(title, download_dir)
